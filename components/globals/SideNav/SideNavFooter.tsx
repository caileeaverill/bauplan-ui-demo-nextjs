...
export default function SidebarFooter({ collapsed }: SidebarFooterProps) {
    ...
    return (
        <footer className={`flex flex-col ${collapsed ? "items-center" : "items-start"} gap-2 w-full px-3 py-4 text-xs text-zinc-300`}>
            {!collapsed ? (
                <div className="flex items-center gap-2">
                    <p className="truncate overflow-hidden whitespace-nowrap transition-opacity duration-600">
